...
class building
{
    private:
        ...
        bool floor_request[2][NUM_FLOORS];  // array of up/down buttons // false = UP, true = DN
    ...
    public:
        ...
        direction get_cars_dir(const int) const;    // find which way car is going
        bool get_floor_req(const int, const int) const;             // check specific floor req
        void set_floor_req(const int, const int, const bool);       // set specific floor req
